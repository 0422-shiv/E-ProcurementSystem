...
<!--%@ page import="com.as.mm.model.Employee" %-->
 <%@ page import="com.example.demo.model.Supplier"%>
...
<% Supplier S= (Supplier)session.getAttribute("SUPSESSION");%>
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src="admin/assets/images/LOGO2.png" alt="homepage" class="dark-logo" />
                         <!-- Light Logo text -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="http://localhost:9098/LogInPage"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    ...
                    <div class="profile-text">
                            <h5>USER</h5>
                               <a href="http://localhost:9098/LogInPage" class="" data-toggle="tooltip" title="Logout"><i class="mdi mdi-power"></i></a>

                        <div class="dropdown-menu animated flipInY">
                        <!-- text-->

                        <a href="http://localhost:9098LogInPage" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                        <!-- text-->
                        </div>
                    </div>
                </div>
...
<li><a class="has-arrow waves-effect waves-dark" href='Activetender' target="mw"><i class="mdi mdi-file"></i><span class="hide-menu">Active Tenders</span></a></li>
<li><a class="has-arrow waves-effect waves-dark" href='contact' target="mw"><i class="mdi mdi-file"></i><span class="hide-menu">Contact INF</span></a></li>
<li><a class="has-arrow waves-effect waves-dark" href='Queries' target="mw"><i class="mdi mdi-file"></i><span class="hide-menu">Queries</span></a></li>
<li><a class="has-arrow waves-effect waves-dark" href='about' target="mw"><i class="mdi mdi-file"></i><span class="hide-menu">About</span></a></li>
<li><a class="has-arrow waves-effect waves-dark" href='/Logout' target="_blank"><i class="mdi mdi-file"></i><span class="hide-menu">Log out</span></a></li>
...
<h3 class="text-themecolor" style="margin-left: 200px;">
<b>Hello  !    <%=S.getSname()  %></b><br>
<img alt="" src="">
