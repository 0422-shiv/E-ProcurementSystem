                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="http://localhost:9098/Logout"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    <!-- User profile image -->
                    <div class="profile-img"> <img src="/AdminImage/Logoshiv.JPG" alt="user" />
                    ...
                    <div class="profile-text">
                            <h5>Admin DRDO</h5>
                               <a href="AdminLogout" class="http://localhost:9098/Logout" data-toggle="tooltip" title="Logout"><i class="mdi mdi-power"></i></a>

                        <div class="dropdown-menu animated flipInY">
                        <!-- text-->

                        <a href="http://localhost:9098/Logout" class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a>
                        <!-- text-->
                        </div>
                    </div>
                </div>
...
<li><a class="has-arrow waves-effect waves-dark" href='tender' target="mw"><i class="mdi mdi-file"></i><span class="hide-menu">Publish Tender</span></a></li>
<li><a class="has-arrow waves-effect waves-dark" href='displayAllTenders' target="mw"><i class="mdi mdi-file"></i><span class="hide-menu">Modify Tenders</span></a></li>

<li><a class="has-arrow waves-effect waves-dark" href='/Bidding' target="mw"><i class="mdi mdi-file"></i><span class="hide-menu">Bidding</span></a></li>

<li><a class="has-arrow waves-effect waves-dark" href='displayAllQuery' target="mw" ><i class="mdi mdi-file"></i><span class="hide-menu">Queries</span></a></li>



<li><a class="has-arrow waves-effect waves-dark" href='AdminLogout' target="_blank" ><i class="mdi mdi-file"></i><span class="hide-menu">Log out</span></a></li>
